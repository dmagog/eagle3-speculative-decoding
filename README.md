...
**`tools/make_pdf.sh`** собирает PDF: прячет служебный код, встраивает KaTeX и печатает через браузер. Появился после того, как формулы в обоих опубликованных PDF оказались сырым LaTeX: nbconvert грузит MathJax из сети, а браузер печатает страницу, не дождавшись его. Теперь сборка идёт офлайн и вовсе не пишет PDF, если формул отрисовалось не 18 или хоть одна дала ошибку.
